...
<%--                <td><img src="${v.img}"></td>--%>
                <td style="width: 180px;">
                    <a href="/article/edit?aid=${v.articleid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                    <a href="/article/delete?aid=${v.articleid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
                    <button path="/article/detail?aid=${v.articleid}"
...
<script>
    ...
    $("#showPage button").click(function () {
        ...
        window.location.href="/article/list?p="+p;   //跳转页面
