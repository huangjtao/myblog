    ...
    <table class="layui-table">
        ...
        <c:forEach items="${content}" var="v">
            ...
            <tr>
                ...
                <td>${v.cmessage}</td>
                <td>${v.ctime}</td>
                <td><img src="${v.cimg}"></td>
                <td style="width: 180px;">
                    <a href="/comment/edit?cid=${v.cid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                    <a href="/comment/delete?cid=${v.cid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
                    <button path="/comment/detail?cid=${v.cid}"
...
<script>
    ...
    $("#showPage button").click(function () {
        ...
        window.location.href="/comment/list?p="+p;   //跳转页面
