        ...
        <c:forEach items="${content}" var="v">
            ...
            <tr>
                ...
                <td style="width: 180px;">
                    <a href="/picture/edit?pid=${v.pid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                    <a href="/picture/delete?pid=${v.pid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
                    <button path="/picture/detail?pid=${v.pid}"
...
<script>
    ...
    $("#showPage button").click(function () {
        ...
        window.location.href="/picture/list?p="+p;   //跳转页面
